...
struct coord2
{
	...
	{
		coord2 rc;
		rc.ux = c.ux.x * ux + c.uy.x * ux;
		rc.uy = c.ux.y * uy + c.uy.y * uy;
		rc.s = s * c.s;
...
struct coord3
{
	...
	{
		coord3 rc;
		rc.ux = c.ux.x * ux + c.uy.x * uy + c.uz.x * uz;
		rc.uy = c.ux.y * ux + c.uy.y * uy + c.uz.y * uz;
		rc.uz = c.ux.z * ux + c.uy.z * uy + c.uz.z * uz;
